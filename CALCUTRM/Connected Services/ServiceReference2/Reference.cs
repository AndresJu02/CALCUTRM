...
namespace CALCULA_TRM.ServiceReference2 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://action.trm.services.generic.action.superfinanciera.nexura.sc.com.co/", ConfigurationName="ServiceReference2.TcrmServicesInterface")]
    public interface TcrmServicesInterface {
        ...
        CALCULA_TRM.ServiceReference2.queryTCRMResponse queryTCRM(CALCULA_TRM.ServiceReference2.queryTCRM request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<CALCULA_TRM.ServiceReference2.queryTCRMResponse> queryTCRMAsync(CALCULA_TRM.ServiceReference2.queryTCRM request);
    }
    ...
    public partial class queryTCRMResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://action.trm.services.generic.action.superfinanciera.nexura.sc.com.co/", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CALCULA_TRM.ServiceReference2.tcrmResponse @return;
        
        public queryTCRMResponse() {
        }
        
        public queryTCRMResponse(CALCULA_TRM.ServiceReference2.tcrmResponse @return) {
            this.@return = @return;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface TcrmServicesInterfaceChannel : CALCULA_TRM.ServiceReference2.TcrmServicesInterface, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TcrmServicesInterfaceClient : System.ServiceModel.ClientBase<CALCULA_TRM.ServiceReference2.TcrmServicesInterface>, CALCULA_TRM.ServiceReference2.TcrmServicesInterface {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CALCULA_TRM.ServiceReference2.queryTCRMResponse CALCULA_TRM.ServiceReference2.TcrmServicesInterface.queryTCRM(CALCULA_TRM.ServiceReference2.queryTCRM request) {
            return base.Channel.queryTCRM(request);
        }
        
        public CALCULA_TRM.ServiceReference2.tcrmResponse queryTCRM(string tcrmQueryAssociatedDate) {
            CALCULA_TRM.ServiceReference2.queryTCRM inValue = new CALCULA_TRM.ServiceReference2.queryTCRM();
            inValue.tcrmQueryAssociatedDate = tcrmQueryAssociatedDate;
            CALCULA_TRM.ServiceReference2.queryTCRMResponse retVal = ((CALCULA_TRM.ServiceReference2.TcrmServicesInterface)(this)).queryTCRM(inValue);
            return retVal.@return;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CALCULA_TRM.ServiceReference2.queryTCRMResponse> CALCULA_TRM.ServiceReference2.TcrmServicesInterface.queryTCRMAsync(CALCULA_TRM.ServiceReference2.queryTCRM request) {
            return base.Channel.queryTCRMAsync(request);
        }
        
        public System.Threading.Tasks.Task<CALCULA_TRM.ServiceReference2.queryTCRMResponse> queryTCRMAsync(string tcrmQueryAssociatedDate) {
            CALCULA_TRM.ServiceReference2.queryTCRM inValue = new CALCULA_TRM.ServiceReference2.queryTCRM();
            inValue.tcrmQueryAssociatedDate = tcrmQueryAssociatedDate;
            return ((CALCULA_TRM.ServiceReference2.TcrmServicesInterface)(this)).queryTCRMAsync(inValue);
        }
    }
}
